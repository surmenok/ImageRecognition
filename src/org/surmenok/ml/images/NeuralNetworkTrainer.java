...
public class NeuralNetworkTrainer {
    ...
    private void train(int inputSize, int outputSize, String trainingType, String activationType, int hiddenLayersCount, int hiddenLayerNeuronCount) throws IOException {
        ...
        out.println(trainingType + "," + activationType + "," + hiddenLayersCount + "," + hiddenLayerNeuronCount + epochsCount + "," + (validationErrorSum / iterationsCount) + "," + (elapsedSum / iterationsCount) + "," + iterationsCount + "," + (classificationErrorSum / iterationsCount));
        out.flush();
        out.close();
    }
    ...
    private BasicNetwork trainNetwork(
        ...
        //todo: move to a separate class
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("c:\\Stuff\\FaceTests\\train_" + trainingType + "_" + activationType + "_" + hiddenLayersCount + "_" + hiddenLayerNeuronsCount + "_" + epochsCount + ".csv", true)));
